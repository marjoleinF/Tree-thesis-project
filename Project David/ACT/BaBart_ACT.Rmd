...
data(ACTG175)
sapply(ACTG175, function(x) sum(is.na(x)))
## Remove missings
ACTG175 <- ACTG175[!is.na(ACTG175$cd4), ]

sapply(ACTG175, class)
...
lt <- lmertree(cd4 ~ time | (1|pidnum) | gender + wtkg + hemo + homo + drugs + karnof +
               oprior + z30 + zprior + race + str2 + symptom + treat + offtrt,
         data = ACTG175, cluster = pidnum)
plot(lt$tree)
