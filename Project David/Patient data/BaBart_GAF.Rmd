...
```{r}
# save MSE as CSV
write.csv(x = MSE, file = paste("MSE","GAF",if(baygen){paste0("baygen[",paste(ngensizes, collapse = ","),"]")}else{paste0("smearing[",paste0(palts*100,"%", collapse = ","),"]")}, if(use_weights){"weighted"}, sep = "_"))

# save tree_size as CSV
write.csv(x = tree_size, file = paste("TreeSize","GAF",if(baygen){paste0("baygen[",paste(ngensizes, collapse = ","),"]")}else{paste0("smearing[",paste0(palts*100,"%", collapse = ","),"]")}, if(use_weights){"weighted"}, sep = "_"))
```
